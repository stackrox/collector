...
setupGCPVM() {
  ...
  if test "$GCP_VM_TYPE" = "ubuntu-os" ; then
    createGCPVM ubuntu-1804-lts "$GCP_VM_TYPE-cloud"
  elif test "$GCP_VM_TYPE" = "rhel" ; then
    createGCPVM rhel-7 "$GCP_VM_TYPE-cloud"
  elif test "$GCP_VM_TYPE" = "cos" ; then
    createGCPVM cos-stable "$GCP_VM_TYPE-cloud"
  elif test "$GCP_VM_TYPE" = "coreos" ; then
    GCP_VM_USER="core"
    createGCPVM coreos-stable "$GCP_VM_TYPE-cloud"
  else
