...
class ResourceSelector {
 public:
  ...
  static bool IsFeatureEnabledForClusterAndNamespace(const std::vector<storage::RuntimeFilter_RuntimeFilterRule>& filteringRules, const UnorderedMap<std::string, storage::ResourceCollection> rcMap, bool defaultStatus, const std::string& cluster, const std::string& ns);
