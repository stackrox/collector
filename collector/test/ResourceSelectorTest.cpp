...
TEST_F(ResourceSelectorTest, MultipleResourceCollectionRules) {
  ...
  storage::RuntimeFilter_RuntimeFilterRule filteringRule1;
  storage::RuntimeFilter_RuntimeFilterRule filteringRule2;
  storage::RuntimeFilter_RuntimeFilterRule filteringRule3;

  filteringRule1.set_status("on");
  filteringRule1.set_resource_collection_id(collectionId1);

  filteringRule2.set_status("off");
  filteringRule2.set_resource_collection_id(collectionId2);

  filteringRule3.set_status("on");
  filteringRule3.set_resource_collection_id(collectionId3);

  std::vector<storage::RuntimeFilter_RuntimeFilterRule> filteringRules = {filteringRule1, filteringRule2, filteringRule3};
