...
//
#define MAX_THREAD_TABLE_SIZE 524288
#define DEFAULT_THREAD_TABLE_SIZE 262144
...
//
#define DEFAULT_THREAD_TIMEOUT_S 30

//
// How often the thread table is scanned for inactive threads
//
#define DEFAULT_INACTIVE_THREAD_SCAN_TIME_S 60
